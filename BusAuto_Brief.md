...
| Роль | Людина | Формат | Зарплата | Примітка |
|---|---|---|---|---|
| Власник / закупівля | Олексій Петров | — | — | Ще в оперативці — мета вийти |
| Продавець (онлайн) | Олександр | Remote | — | Автопро, Prom, Rozetka + частково закупки |
| Продавець (магазин) | Максим Філягін | Офлайн | — | automobil.in.ua, дзвінки, розрахунки |
| Продавець (підхват) | Олександр Капустян | Remote | — | Дзвінки, месенджери |
| Бухгалтер | — | — | 7 500 ₴/міс | Веде всі 3 ФОПи |
| Касир / узгодження | Олена | — | 6 000 ₴/тиждень (~24 000/міс) | Проведення платежів, узгодження |
| Водій | — | 1 раз/тиждень | 1 000 ₴/тиждень (~4 000/міс) | Доставка |
| Комірник | Владислав | — | 7 000 ₴/тиждень (~28 000/міс) | Склад |
| **Продавці (3)** | — | — | **120 000 ₴/міс (всього)** | Загальний ФОП на трьох |
| Рекл.агенція | PPCexperts | Зовнішня | 10 000 ₴/міс | automobil.in.ua Google Ads |
| Рекл.агенція | Internetsolutions | Зовнішня | 10 000 ₴/міс | busauto.kh.ua Google Ads |
