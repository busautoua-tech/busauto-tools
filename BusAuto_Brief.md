...
- **Google Ads** — два активних аккаунти + один у перспективі:
  ...
  - 🔜 busauto.ua — реклама НЕ запущена. Блокери: GTM/GA4 відсутні, EN рядки в кошику, артикул не відображається, OG description з чужим доменом. Деталі: `Developer_Tasks_v2_busauto.docx`
...
- 🔧 Canonical теги: **відсутні** на сторінках товарів (підтверджено аудитом 06.06.2026)
...
### Аудит задач для розробника (06.06.2026)
- 📄 Актуальний список задач: `Developer_Tasks_v2_busauto.docx`
- ✅ **Виконано розробником**: robots.txt (Disallow: /shop?), Sitemap (3 підкарти), OG теги (частково)
- ❌ **Не виконано**: GTM/GA4/конверсії, артикул на картці, Schema.org, canonical, landing по марках, локалізація ("Shopping Cart" / "Not Available For Sale" досі EN)
- 🆕 **Нові проблеми**: GA4 відсутній в HTML; `/shop/toyota` → 404

### Пріоритетні залишки
- 🔴 **БЛОКЕР РЕКЛАМИ**: підключити GTM + GA4 + Google Ads конверсію на busauto.ua
- ✅ Виправити OG description (чужий домен) — виконано 06.06.2026
- 🔴 Локалізація EN рядків ("Shopping Cart" / "Not Available For Sale") → розробнику
